...
export default function Contact() {
  ...
  return (
    <section ref={container} className="bg-zinc-950 py-24 px-6 md:px-12 lg:px-24 text-white">
      <div className="max-w-7xl mx-auto">
        ...
        <form ref={formRef} className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
          ...
          <div className="form-row flex flex-col gap-4 border-b border-zinc-800 pb-4 focus-within:border-lime-400 transition-colors duration-500">
            <label className="font-mono text-xs uppercase tracking-widest text-zinc-500">01 / Name</label>
            <input 
              type="text" 
          ...
          {/* Email Field */}
          <div className="form-row flex flex-col gap-4 border-b border-zinc-800 pb-4 focus-within:border-lime-400 transition-colors duration-500">
            <label className="font-mono text-xs uppercase tracking-widest text-zinc-500">02 / Email</label>
            <input 
              type="email" 
          ...
          <div className="form-row md:col-span-2 flex flex-col gap-4 border-b border-zinc-800 pb-4 focus-within:border-lime-400 transition-colors duration-500">
            <label className="font-mono text-xs uppercase tracking-widest text-zinc-500">03 / Message</label>
            <textarea 
              rows={2}
          ...
          <div className="form-row md:col-span-2 flex justify-center md:justify-end">
            <Magnetic>          
            <button className="relative overflow-hidden bg-lime-400 text-zinc-950 px-6 py-2 rounded-full font-bold text-lg md:text-2xl uppercase tracking-tighter cursor-pointer">
