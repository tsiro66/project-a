  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        <h2 className="font-syne font-black text-3xl md:text-6xl uppercase tracking-tighter mb-16">
          {section.title}
        </h2>
          ...
          {section.items.map((item, i) => (
            ...
            >
              <div className="flex items-center justify-between py-8">
                ...
                <h3
                  className={`flex-1 font-syne font-bold text-xl md:text-2xl uppercase transition-colors duration-300 ${
                    activeIndex === i ? "text-lime-400" : "text-zinc-100"
                  }`}
                >
                  {item.q}
                </h3>
